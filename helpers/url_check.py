...
if __name__ == '__main__':
    ...
    assert is_permitted('https://ics.uci.edu/bin/') == False
    assert is_permitted('https://ics.uci.edu/bin/random.txt') == False
    assert is_permitted('https://ics.uci.edu/~mpufal/') == False
    assert is_permitted('https://ics.uci.edu/~thornton/') == True
    assert is_permitted('https://ics.uci.edu/~fakeprof/') == True
